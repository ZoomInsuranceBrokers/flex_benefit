            ...
            <div class="tab-content">
                ...
                <div class="tabs">
                    <button class="tablinks" data-country="network-hospitals">
                        <p data-title="Network Hospitals">Claim Reimbursement</p>
                    </button>
                ...
                <div class="wrapper_tabcontent">
                    <div id="network-hospitals" class="tabcontent active">
                        ...
                        @endif
                        <form action="{{ url('/claim/phs/reimbursement') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="input002" class="col-sm-12 control-label form-label">Upload Document<span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                            <input name="document" type="file" class="form-control" id="file" placeholder="Upload Document" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
