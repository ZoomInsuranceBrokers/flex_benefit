                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    @if (Auth::check())
                        ...
                        <li class="nav-item dropdown" id="pointsInfo">
                            <a class="nav-link d-flex align-items-center" href="#" id="walletDropdown"
                                role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="profile-img">
                                    <img src="{{ asset('assets/images/wallet-png.png') }}" alt="profile"
                                        style="width: 28px;" />
                                </span>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="walletDropdown" style="width: max-content;border-radius:20px;">
                                ...
                                <div class="walliet-div"><li class="wallet-break-line"></li></div>
                                <div class="wallet-score">
                                   
                                    <div class="walliet-div"><li class="wallet-litags"><span class="dropdown-item-wallet" style="text-align: center;">*FP(FlexPoints)</span></li></div>
                                </div>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown profile-dropdown" style="background: none;">
                            <a class="nav-link dropdown-toggle shape-container" href="#" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false" class="d-flex">
                                <div class="circle"> <span class="profile-img"><img
                                            src="{{ asset('assets/images//profile.jpg') }}" alt="profile" /></span>
                                </div>
                                <div class="rectangle"><span>{{ Auth::user()->fname }} <i
                                            class="fa-solid fa-list ms-2"></i></span></div>
                            </a>
                            <ul class="dropdown-menu me-2">
                                @if (Auth::check())
                                    <li><a class="dropdown-item userProfileTrigger" data-bs-toggle="modal"
                                            data-bs-target="#userProfileModal">User Profile</a></li>
                                    <!--
                        ...
                        <li><a class="dropdown-item" href="{{ asset('assets/documents/MyBenefits@Zoom.pdf') }}"
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <li class="nav-item dropdown profile-dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="modal"
                                data-bs-target="#loginModal" class="d-flex">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-3 d-flex btns">
                    ...
                    <a class="nav-link" href="/user/logout"><button type="submit"
                            class="btn primary--btn d-block mx-auto" style="background:var(--blue); color:white">
                            Logout
                        </button></a>
                </div>
            </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                mapUserFYPolicyData.forEach(function(item) {
                    ...
                    if (points !== 0) {
                        ...
                        var $categoryLi = $('<li>').addClass('wallet-litags').append(
                            ...
                            $('<span>').addClass('dropdown-item-wallet').css({'text-align': 'center', 'font-weight': '600'}).text(points)
                        );
                ...
                var $totalLi = $('<li>').addClass('wallet-litags').append(
                    $('<span>').addClass('dropdown-item-wallet').css({'font-weight': '600', 'color': 'black'}).text('Total'),
                    $('<span>').addClass('dropdown-item-wallet').css({'text-align': 'center', 'font-weight': '600'}).text(totalPoints)
                );
                ...
                var $fpLi = $('<li>').addClass('wallet-litags').append(
                    $('<span>').addClass('dropdown-item-wallet').css({'text-align': 'center'}).text('*FP(FlexPoints)')
                );
